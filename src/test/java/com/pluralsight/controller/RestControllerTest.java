...
public class RestControllerTest {
	...
	public void testCreateRide() {
		...
		Ride ride = new Ride();
		ride.setName("Georgs Spring Ride 2");
		ride.setDuration(3000);
	...
	public void testGetRides() {
		...
		for (Ride ride : rides) {
			System.out.println("Ride name: " + ride.getName() + ", Time: " + ride.getDuration());
		}
	}
	...
	public void testException() {
		RestTemplate restTemplate = new RestTemplate();
		restTemplate.delete("http://localhost:8080/ride_tracker/test", Ride.class);
	}
